...
Rails.application.config.assets.precompile += %w( active_admin.css active_admin.js datatables.min.js datatables.min.css Config.js kendo.dataviz.min.js select.bootstrap4.min.css dataTables.select.min.js )
