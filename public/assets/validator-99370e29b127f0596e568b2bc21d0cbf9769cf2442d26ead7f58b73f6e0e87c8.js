...
function formReceiptTemplate() {
  ...
  $('#est1ReceiptCallsJetsons').val(
    ...
    +'\n"Please note, final claim approval is contingent on technician contacting New Leaf through the parts verification line at (855) 608-4501 at the time of service (prior to installing parts) for New Leaf to obtain parts verification by the customer. Additionally, service provider is required to submit a SIGNED Parts Invoice by the customer at completion. FAILURE TO FOLLOW THIS PROCEDURE WILL RESULT IN CLAIM PAYMENT BEING REJECTED."' 
  );
