...
function samVal() {
	...
	function a() {
    	...
    	for (var i = 0; i < snArray.length; i++) {
    		if (modVal.toUpperCase().includes("RF", 0) == true) {
        		$('#modelNumberCalls').addClass("alert-calls");
    		};
    		if ((serVal.toUpperCase().includes(snArray[i], 5) == true) && (modVal.toUpperCase().includes("RF", 0-2) == true)) {
...
function samVal2() {
	...
	function a2() {
    	...
    	for (var i = 0; i < snArray2.length; i++) {
    		if (modVal2.toUpperCase().includes("RF", 0) == true) {
