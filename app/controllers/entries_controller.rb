  ...
  def dashboard
    ...
    if current_user.has_role?(:executive) then
      #Dan/dad/rick
           ...
           @agent_occurrence_values = Entry.effective.joins(:occurrence, agent: :user).group('users.id', 'users.first_name', 'users.last_name').sum(:ovalue)
      ...
      then @chart_data_dept_today = Entry.today.grouped_dept.where('departments.name = ? OR departments.name = ?', 'Ferguson', 'Service-Contract').order('departments.name asc').sum(:ovalue).values
           ...
           @agent_occurrence_values = Entry.effective.joins(:occurrence, agent: [:user, :department]).group('users.id', 'users.first_name', 'users.last_name').where('departments.name = ? OR departments.name = ?', 'Ferguson', 'Service-Contract').order("users.first_name, users.last_name").sum(:ovalue)
      ...
      then @chart_data_dept_today = Entry.today.grouped_dept.where('departments.name = ? OR departments.name = ? OR departments.name = ? OR departments.name = ?', 'Claims', 'Service-Network', 'Pre-Approvals', 'Pending-Review').order('departments.name asc').sum(:ovalue).values
           ...
           @agent_occurrence_values = Entry.effective.joins(:occurrence, agent: [:user, :department]).group('users.id', 'users.first_name', 'users.last_name').where('departments.name = ? OR departments.name = ? OR departments.name = ? OR departments.name = ?', 'Claims', 'Service-Network', 'Pre-Approvals', 'Pending-Review').order("users.first_name, users.last_name").sum(:ovalue)
      ...
      then @chart_data_dept_today = Entry.today.grouped_dept.where('departments.name = ? OR departments.name = ?', 'Claims', 'Service-Network').order('departments.name asc').sum(:ovalue).values
           ...
           @agent_occurrence_values = Entry.effective.joins(:occurrence, agent: [:user, :department]).group('users.id', 'users.first_name', 'users.last_name').where('departments.name = ? OR departments.name = ?', 'Claims', 'Service-Network').order("users.first_name, users.last_name").sum(:ovalue)           
      ...
      then @chart_data_dept_today = Entry.today.grouped_dept.where('departments.name = ? OR departments.name = ?', 'Pre-Approvals', 'Pending-Review').order('departments.name asc').sum(:ovalue).values
           ...
           @agent_occurrence_values = Entry.effective.joins(:occurrence, agent: [:user, :department]).group('users.id', 'users.first_name', 'users.last_name').where('departments.name = ? OR departments.name = ?', 'Pre-Approvals', 'Pending-Review').order("users.first_name, users.last_name").sum(:ovalue)                      
