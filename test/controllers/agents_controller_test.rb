...
class AgentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agent" do
    assert_difference('Agent.count') do
      post agents_url, params: { agent: { fname: @agent.fname, hire: @agent.hire, lname: @agent.lname } }
    end
  ...
  test "should update agent" do
    patch agent_url(@agent), params: { agent: { fname: @agent.fname, hire: @agent.hire, lname: @agent.lname } }
