...
class OccurrencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create occurrence" do
    assert_difference('Occurrence.count') do
      post occurrences_url, params: { occurrence: { desc: @occurrence.desc, odate: @occurrence.odate, type: @occurrence.type } }
    end
  ...
  test "should update occurrence" do
    patch occurrence_url(@occurrence), params: { occurrence: { desc: @occurrence.desc, odate: @occurrence.odate, type: @occurrence.type } }
