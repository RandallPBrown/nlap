...
class IncentivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incentive" do
    assert_difference('Incentive.count') do
      post incentives_url, params: { incentive: { errors: @incentive.errors, occupancy: @incentive.occupancy, quality: @incentive.quality, uph: @incentive.uph, user_id: @incentive.user_id } }
    end
  ...
  test "should update incentive" do
    patch incentive_url(@incentive), params: { incentive: { errors: @incentive.errors, occupancy: @incentive.occupancy, quality: @incentive.quality, uph: @incentive.uph, user_id: @incentive.user_id } }
