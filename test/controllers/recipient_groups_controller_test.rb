...
class RecipientGroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recipient_group" do
    assert_difference('RecipientGroup.count') do
      post recipient_groups_url, params: { recipient_group: { description: @recipient_group.description } }
    end
  ...
  test "should update recipient_group" do
    patch recipient_group_url(@recipient_group), params: { recipient_group: { description: @recipient_group.description } }
